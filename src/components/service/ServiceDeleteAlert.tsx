    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm px-4">
      <div className="bg-surface-container-low border border-outline-variant/15 shadow-xl rounded-xl w-full max-w-sm overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        <div className="p-6 text-center space-y-4">
          ...
          <h2 className="font-display text-title-lg font-bold text-on-surface">Delete Service?</h2>
          <p className="text-body-md text-on-surface-variant">
            Are you sure you want to delete <span className="font-bold text-primary">{selectedService.name}</span>? This action cannot be undone.
          </p>
        </div>
