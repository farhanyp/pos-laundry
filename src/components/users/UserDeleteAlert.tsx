...
export function UserDeleteAlert() {
  ...
  return (
    ...
    >
      <div 
        className="bg-surface-container-lowest border border-outline-variant/20 shadow-2xl rounded-2xl w-full max-w-[400px] flex flex-col transform transition-all animate-in zoom-in-95 duration-200"
      ...
      >
        <div className="p-8 text-center space-y-4">
          ...
          <h2 className="font-display text-[22px] font-bold text-on-surface leading-tight">Hapus Pengguna?</h2>
          <p className="text-[14px] text-on-surface-variant leading-relaxed">
            Apakah Anda yakin ingin menghapus pengguna <span className="font-bold text-primary">{userToDelete.name}</span>? Tindakan ini bersifat permanen dan tidak dapat dibatalkan.
          </p>
        </div>
